assembler: assembler.o LinkedList.o Macro_Handler.o Text_parse.o  Assembler_Pass.o cmd_handler.o asm_utils.o File_utils.o
	gcc -g -Wall -ansi -pedantic -std=c90 assembler.o LinkedList.o  Macro_Handler.o Text_parse.o Assembler_Pass.o cmd_handler.o asm_utils.o File_utils.o -o assembler -lm
...
Assembler_Pass.o: Assembler_Pass.c Assembler_Pass.h Text_parse.o asm_utils.o cmd_handler.o
...
File_utils.o: File_utils.c File_utils.h Text_parse.o
